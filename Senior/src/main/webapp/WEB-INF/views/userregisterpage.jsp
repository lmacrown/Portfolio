                                ...
                                <form class="forms-sample">
                                    <div class="row">
                                        <div class="form-group" style="width:200px; margin-left:10px">
                                            <label for="exampleInputUserNick1">UserNick</label>
                                            <input type="text" class="form-control" id="exampleInputUserNick1"
                                                   placeholder="UserNick" name="userNick">
                                        </div>
                                    ...
                                    <div class="row">
                                        <%--<div class="form-group" style="width:200px;  margin-left:10px">
                                            ...
                                            <input type="password" class="form-control" id="exampleInputPassword2"
                                                   placeholder="Password" name="userRePw">
                                        </div>--%>
                                        <%--<div style="width:150px;">
                                            <a href="../../dashboard-one.html" class="btn btn-primary text-white mr-2 mb-2 mb-md-0">Check</a>
                                        </div>--%>
                                    ...
                                    <div class="mt-3">
                                        <button class="btn btn-primary text-white mr-2 mb-2 mb-md-0"
                                                type="submit" id="sub_btn1" >Sign up</button>
                                        <button class="btn btn-primary text-white mr-2 mb-2 mb-md-0"
                                                type="submit" id="sub_btn2" >Cancel</button>
                                    </div>
                                </form>
                            </form>
                        </div>
...
<script>
    ...
    /* function btn_status() {
         if (document.getElementById("exampleInputUserNick1").value !== '' &&
             document.getElementById("exampleInputEmail1").value !== '' &&
             document.getElementById("exampleInputId1").value !== '' &&
